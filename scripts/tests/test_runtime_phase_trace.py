...
42 100.000050 pread64(3, "loader", 20000, 0) = 20000 <0.000005>
42 100.000060 pread64(3, "header", 192, 20000) = 192 <0.000003>
42 100.000070 pread64(3, "PFGMAN00", 136, 20192) = 136 <0.000003>
42 100.000090 pread64(3, "payload", 200000, 20328) = 200000 <0.000006>
42 100.000110 mmap(0x400000, 500000, PROT_READ|PROT_WRITE, MAP_ANONYMOUS|MAP_FIXED_NOREPLACE, -1, 0) = 0x400000 <0.000005>
42 100.000150 mprotect(0x400000, 4096, PROT_READ) = 0 <0.000003>
42 100.000190 mprotect(0x401000, 8192, PROT_READ|PROT_EXEC) = 0 <0.000003>
42 100.000220 mprotect(0x401000, 4096, PROT_READ) = 0 <0.000004>
43 100.000240 write(1, "ok", 2) = 2 <0.000002>
"""
...
class RuntimePhaseTraceTests(unittest.TestCase):
    ...
    def test_extracts_direct_output_boundaries_and_excludes_target_mprotect(self):
        with tempfile.TemporaryDirectory() as directory:
            path = Path(directory) / "trace"
